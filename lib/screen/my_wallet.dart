...
class _WalletScreenState extends State<WalletScreen> {
  ...
  sendMoeny()async{
    ...
    var request = http.MultipartRequest('POST', Uri.parse('${BaseUrl}wallet_request'));
  ...
  addWalletMoney(txnId)async{
    ...
    print("add wallet money" + parameter.toString() + Apipath.addMoneyToWallet.toString());
